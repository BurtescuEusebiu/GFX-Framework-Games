...
void Lab2::Init()
{
    ...
    {
        vector<VertexFormat> vertices{
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)),       // 0 - 0
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),       // 4 - 1
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),       // 5 - 2
            VertexFormat(glm::vec3(0.5f, 1, 0.5f), glm::vec3(0, 0, 0), glm::vec3(0.2, 0.8, 0.6)), // top
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(2, 0, 3), glm::vec3(0.25f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(5, 0, 5), glm::vec3(0.25f));

    // TODO(student): Draw the square
    RenderMesh(meshes["patrat"], shaders["VertexColor"], glm::vec3(2, 0, 2), glm::vec3(0.25f));
